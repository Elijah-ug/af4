...
import { messageMutations } from "../queries/user/messages/messageMutations";
...
export const store = configureStore({
  reducer: {
    ...
    [messageMutations.reducerPath]: messageMutations.reducer,
    [messageQueries.reducerPath]: messageQueries.reducer,
  },
  middleware: (getDefaultMiddleware) =>
    getDefaultMiddleware().concat(
      userMutations.middleware,
      fetchUserQueries.middleware,
      messageMutations.middleware,
